...
//       await fetch("http://localhost:8888/read-todos/" + prevElId)
//         .then((data) => {
...
//       await fetch("http://localhost:8888/read-todos/" + nextElId)
//         .then((data) => {
//           return await data.json();
//         })
//         .then((json) => {
...
//     const updateUrl = "http://localhost:8888/order-todos/" + currElId;
...
//   const updateUrl = "http://localhost:8888/edit-todos/" + id;
//   await fetch(updateUrl, {
//     method: "POST",
//     headers: {
//       "Content-type": "application/json",
...
//   const deleteUrl = "http://localhost:8888/delete-todos/" + id;
